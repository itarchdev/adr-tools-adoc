...
A command-line tool for working with a log of link:https://thinkrelevance.com/blog/2011/11/15/documenting-architecture-decisions[Architecture Decision Records] (ADRs).

image:https://travis-ci.org/npryce/adr-tools.svg?branch=master[Build Status, link="https://travis-ci.org/npryce/adr-tools"]

== Quick Start

link:INSTALL.md[Install ADR Tools].
...
----
+
This will create a directory named `doc/architecture/decisions` containing the first ADR, which records that you are using ADRs to record architectural decisions and links to link:https://thinkrelevance.com/blog/2011/11/15/documenting-architecture-decisions[Michael Nygard's article on the subject].
...
The decisions for this tool are recorded as link:doc/adr/[architecture decision records in the project repository].
